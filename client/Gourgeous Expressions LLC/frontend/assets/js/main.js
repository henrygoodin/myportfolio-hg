...
(function() {
  ...
  document.getElementById('contactForm').addEventListener('submit', async function (event) {
    ...
    // Ensure ALL messages are hidden before sending request
    ...
    try {
      const response = await fetch('http://localhost:3202/api/contacts/submit', {
        method: 'POST',
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    console.log(faqItems); // Check if elements exist

    faqItems.forEach(item => {
        item.addEventListener("click", () => {
            console.log("FAQ item clicked:", item.textContent);
        });
    });
});
